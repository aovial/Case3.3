...
if pages == 'Home':
    ...
    st.subheader("Hier worden de visualisaties weergegeven die wij hebben opgesteld."), st.image("map.png", width=None ,output_format='auto'), folium_static(m), st.image("12 uur.png", width=None, output_format='auto'), st.image("8 uur.png", width=None, output_format='auto'), st.plotly_chart(fig1), st.plotly_chart(fig2), st.plotly_chart(fig3) 
elif pages == 'Einde':
